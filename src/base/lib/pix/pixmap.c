...
REFTYPE(OldPixMap_reftype, "OldPixMap", OldPixMapIdent, OldPixMapAdmin);
...
static Var_t var_OldPixMap[] = {
	{ "color", &Type_vec, NULL, 0, 0, get_color, NULL },
	{ "width", &Type_int, NULL, 0, 0, ConstMember, m_cols },
	{ "height", &Type_int, NULL, 0, 0, ConstMember, m_rows },
};
...
void SetupOldPixMap(void)
{
	...
	AddVar(Type_OldPixMap.vtab, var_OldPixMap, tabsize(var_OldPixMap));
	/*
