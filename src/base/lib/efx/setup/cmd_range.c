...
static EfiFuncDef fdef_range[] = {
	...
	{ VLFUNC, "operator: (long a, long b)", RangeFunc },
	{ VLFUNC, "operator: (long a, long b, long s)", RangeFunc },
	{ VLFUNC, "operator: (unsigned a, unsigned b)", RangeFunc },
	{ VLFUNC, "operator: (unsigned a, unsigned b, unsigned s)", RangeFunc },
	{ VLFUNC, "operator: (size_t a, size_t b)", RangeFunc },
	{ VLFUNC, "operator: (size_t a, size_t b, size_t s)", RangeFunc },
