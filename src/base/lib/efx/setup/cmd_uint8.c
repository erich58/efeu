/*
8-Bit vorzeichenlose Ganzzahlobjekte
...
{
	return io_xprintf(io, "%hhu", *((T *) data));
}

EfiType Type_uint8 = SIMPLE_TYPE(S, T, NULL, print_data);
...
static EfiFuncDef ctab[] = {
	...
	{ FUNC_PROMOTION, &Type_int16, S " ()", c_int16 },
	...
	{ FUNC_PROMOTION, &Type_uint16, S " ()", c_uint16 },
	{ FUNC_PROMOTION, &Type_uint32, S " ()", c_uint32 },
	{ FUNC_PROMOTION, &Type_uint64, S " ()", c_uint64 },
	{ FUNC_PROMOTION, &Type_varsize, S " ()", c_uint64 },
};
