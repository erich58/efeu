...
/*	Poissonverteilung: Bei großem Mittelwert wird eine Normalverteilung
	verwendet. Ab 9 sind die Werte annähernd normalverteilt, ab 700
	kommt es zu einem Überlauf bei der Berechnung.
*/
