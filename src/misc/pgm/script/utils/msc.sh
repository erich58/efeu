...
# $pconfig
# Version="$Id: msc.sh,v 1.1 2008-03-02 15:49:51 ef Exp $"
# file |
#	name of file
# :mdprint options |
#	mdprint options
...
# $Description
# :*:
# The command allows to edit the data cube <file> as |sc| spreadsheet.
...
msg4="
The command allows to edit the data cube \"%s\" as sc spreadsheet.
Depending on the mdprint options, the data cube may be changed.
You should edit carefully, a incorrect syntax may result in
data loss.\n
"
